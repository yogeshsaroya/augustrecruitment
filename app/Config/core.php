 ...
 */
	//Configure::write('Routing.prefixes', array('admin'));
		Configure::write('Routing.prefixes', array('back'));
 ...
 */
	Configure::write('Security.salt', 'DYhG935464rtydfyJfIxfs2guVoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '7685930998765 3542496749683645');
